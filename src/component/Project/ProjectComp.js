...
function ProjectComp(props) {
    return(
        <div className='w-full mb-4 origin-center md:transform hover:-translate-y-6 shadow-lg'>
            ...
            <div className='w-full py-4 text-center bg-primary-default px-4'>
                <h3 className=' text-xs pb-2'>{props.desc}</h3>
                <div className="justify-around flex mt-4">
                    <a href={props.git_link} className="text-secondary-default">
                    ...
                    <a href={props.project_link} className="text-secondary-default">
