...
function BlogComp(props) {
    return (
        <div className="mt-12 rounded-2xl shadow-lg mb-12 bg-primary-default">
                  ...
                  <tr>
                      ...
                      <p className='text-xs md:text-sm p-12 text-center'>
                        ...
                        <div className="hidden md:flex justify-center"> 
                            <a href={props.link} className="bg-secondary-default text-white px-4 py-2 rounded-lg shadow-lg">View My Content</a>
                        </div>
                        <div className="md:hidden justify-center"> 
                            <a href={props.link} className="bg-secondary-default text-white px-2 py-1 rounded-lg shadow-lg">Content</a>
                        </div>
                    </p>
                      </td>
                  </tr>
